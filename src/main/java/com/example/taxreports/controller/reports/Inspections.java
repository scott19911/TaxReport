...
import static com.example.taxreports.util.ServletsName.INSPECTIONS;
...
public class Inspections  extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (presentStatus == 0){
            ...
            request.getRequestDispatcher(ServletsName.ERROR).forward(request, response);
        ...
        switch (action){
            case ReportBean.STATUS_ACCEPTED:
                ...
                response.sendRedirect(ServletsName.REPORT_LIST);
                return;
            ...
            default: int createrId =  reportsDAO.getIdCreaterReport(idReport);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher(Page.COMMENT);
