    ...
    <div class="container-login100" style="background-image: url('Login_v16/images/bg-01.jpg');">
        <div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					<fmt:message key="Recoverpassword"/>
				</span>
            <form class="login100-form validate-form p-b-33 p-t-5"action="restorPass" method="post" onsubmit="return validate()">

                <div class="wrap-input100 validate-input" data-validate = "<fmt:message key="email"/> <fmt:message key="or"/> <fmt:message key="login"/>">
