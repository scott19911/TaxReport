  ...
  <div class="container">
    ...
    <div class="checkbox" id="filter">
      <ul class="ks-cboxtags">
        <li><input type="checkbox" id="checkboxOne" value="1"><label for="checkboxOne"><fmt:message key="filed"/></label></li>
        <li><input type="checkbox" id="checkboxTwo" value="2" checked><label for="checkboxTwo"><fmt:message key="accepted"/></label></li>
        <li><input type="checkbox" id="checkboxThree" value="3" checked><label for="checkboxThree"><fmt:message key="reject"/></label></li>
        <c:if test='${!user.getRole().equals("insp")}'>
          <li><input type="checkbox" id="checkboxFour" value="4"><label for="checkboxFour"><fmt:message key="edit"/></label></li>
        </c:if>
        <li><input type="checkbox" id="checkboxFive" value="5"><label for="checkboxFive"><fmt:message key="update"/></label></li>
        <li><input type="checkbox" id="checkboxSix" value="6" checked><label for="checkboxSix"><fmt:message key="processing"/></label></li>
      </ul>
    </div>
    <br>
